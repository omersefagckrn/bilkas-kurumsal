	...
	return (
		...
		>
			...
			<div className='flex flex-col items-start justify-start pt-[20px] pr-[40px] pb-[16px]'>
				<h3 className='text-lg font-semibold mb-2 text-[#333] underline underline-offset-4'>{work.title}</h3>
...
const Blog = () => {
	...
	return (
		<section id='blog' className='py-12 bg-appbggray'>
			<motion.div className='container w-full mx-auto' initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: 'easeOut' }}>
